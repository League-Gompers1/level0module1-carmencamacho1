 ...
 * the rocket can’t start and millions of dollars are lost! In a moment of
 * great bravery you remember you learned how to count (a long time ago in High
...
public class NasaCountdown {
	public static void main(String[] args) {
		...
		String o = JOptionPane.showInputDialog("Type a number to start from");
		
		// 3. convert the user's answer to an int (Integer.parseInt)
		int oAsInt = Integer.parseInt(o);
		// 4. countdown from user's starting point
		
		// 1. countdown from 10 to 0
for(int i=oAsInt; i >=0; i= i-1){
